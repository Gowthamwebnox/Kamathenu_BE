...
const fetchSellerProfileService_1 = require("../../../services/admin/fetchSellerProfileService");
    ...
    try {
        ...
        const parsedIsApproved = isApproved === 'true' ? 'Approved' :
            isApproved === 'false' ? 'Pending' :
                'Approved';
        const sellerProfile = yield (0, fetchSellerProfileService_1.fetchSellerProfileService)(parsedSearch, parsedLimit, parsedOffset, parsedIsApproved);
