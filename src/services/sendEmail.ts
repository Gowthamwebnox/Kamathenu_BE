...
if(emailTriggerData.otp!==undefined){
    var mailOptions = {
      ...
      text: `Hi ${emailTriggerData.name||'user'},Your OTP is: ${emailTriggerData.otp}`
    };
    ...
    if(emailTriggerData.message!==undefined){
       var mailMessage = {
        ...
        to: emailTriggerData.email,
        subject: `${emailTriggerData.subject} - ${emailTriggerData.name||'user'}`,
